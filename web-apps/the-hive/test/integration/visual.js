...
xdescribe('👀 page screenshots are correct', function() {
  ...
  describe('wide screen', function() {
    ...
    it('/tracks', async function() {
      return takeAndCompareScreenshot(page, 'tracks', 'wide');
    });
  ...
  describe('narrow screen', function() {
    ...
    it('/tracks', async function() {
      return takeAndCompareScreenshot(page, 'tracks', 'narrow');
    });
    it('/404', async function() {
